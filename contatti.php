...
if(isset($_GET['send']) and ($_GET['send']=='1')) {
 ...
 // Controllo Email
    if ((validations_richiesto($mittente) == FALSE) or (validations_email($mittente) == FALSE)) :
   	...
   	// Controllo Messaggio
    if ((validations_richiesto($messaggio) == FALSE) or (validations_lunghezza(0, 600, $messaggio) == FALSE)) :
    	$validazione = FALSE;
				...
				<form  class="popup-form"  method="post" action="contatti.php?send=1">
					...
					<div class="checkbox-holder text-left">
						<h4>Come posso aiutarti?</h4>
						 <textarea class="form-control" placeholder="testo" rows="5" id="comment" name="text" value="<?php if (isset($messaggio)) echo $messaggio;?>"></textarea>
